...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .card.vmware {{ --card-color: var(--vmware); }}
  ...
  .badge.VMware {{ background: var(--vmware-bg); color: var(--vmware); }}
...
<body>
<h1>Firmware &amp; patch checker — HPE / Dell / IBM / VMware</h1>
...
function renderCards() {{
  ...
  const order = ["HPE", "Dell", "IBM", "VMware"];
